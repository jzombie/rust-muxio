...
//     fn decode_request(req_bytes: &[u8]) -> Result<Self::Input, io::Error> {
//         bitcode::decode(req_bytes).map_err(|e| io::Error::new(io::ErrorKind::InvalidData, e))
//     }
...
//     fn decode_response(resp_bytes: &[u8]) -> Result<Self::Output, io::Error> {
//         bitcode::decode(resp_bytes).map_err(|e| io::Error::new(io::ErrorKind::InvalidData, e))
//     }
// }
...
//     fn decode_request(req_bytes: &[u8]) -> Result<Self::Input, io::Error> {
//         <T as BitcodeRpcMethodPrebuffered>::decode_request(req_bytes)
//     }
...
//     fn decode_response(resp_bytes: &[u8]) -> Result<Self::Output, io::Error> {
//         <T as BitcodeRpcMethodPrebuffered>::decode_response(resp_bytes)
//     }
// }
